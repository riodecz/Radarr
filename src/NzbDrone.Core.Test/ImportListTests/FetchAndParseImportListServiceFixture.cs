...
namespace NzbDrone.Core.Test.ImportListTests
{
    ...
    public class FetchAndParseImportListServiceFixture : CoreTest<FetchAndParseImportListService>
    {
        ...
        private List<ListMovie> _listMovies;
        ...
        public void Setup()
        {
            ...
            _listMovies = Builder<ListMovie>.CreateListOfSize(5)
                .Build().ToList();
        ...
        public void should_store_movies_if_list_doesnt_fail()
        {
            ...
            Mocker.GetMock<IListMovieService>()
                .Verify(v => v.SyncMoviesForList(It.IsAny<List<ListMovie>>(), listId), Times.Once());
        }
        ...
        public void should_not_store_movies_if_list_fails()
        {
            ...
            Mocker.GetMock<IListMovieService>()
                .Verify(v => v.SyncMoviesForList(It.IsAny<List<ListMovie>>(), listId), Times.Never());
        }
        ...
        public void should_only_store_movies_for_lists_that_dont_fail()
        {
            ...
            Mocker.GetMock<IListMovieService>()
                .Verify(v => v.SyncMoviesForList(It.IsAny<List<ListMovie>>(), passedListId), Times.Once());
        }
